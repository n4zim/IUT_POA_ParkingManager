...
public class Parking {
	...
	public void genererFacture() {
		...
		System.out.println("Facture numéro " + numeroFacture++ + "Prix TTC : "
				+ montant + "Merci d'avoir utilisé le parking POO.");
	}
	...
	public Vehicule unpark(Integer numeroPlace) throws PlaceLibreException,
			PlaceInexistanteException, TypePlaceInvalideException,
			PlaceOccupeeException, PlaceReserveeException,
	...
	public void reorganiserPlaces() throws PlusAucunePlaceException {
		...
		while (it.hasNext()) {
			Place placeCourrante = ((Entry<Integer, Place>) it.next())
					.getValue();
	...
	public Vehicule retirerVehicule(String numeroImmatriculation)
			throws PlaceLibreException, PlaceInexistanteException,
			TypePlaceInvalideException, PlaceOccupeeException,
			PlaceReserveeException, PlusAucunePlaceException {
