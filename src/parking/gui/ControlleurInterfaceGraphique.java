...
public class ControlleurInterfaceGraphique extends JFrame {
	...
	/**
	 * Doit être appellée quand l'état du parking change. Se charge de mettre à
	 * jour les fenêtres qui ont besoin de l'état du parking.
	 **/
	 ...
	 * @param place
	 *            le numéro de place
	 * @throws TypePlaceInvalideException
	 *             La place n'est pas adaptée à ce type de véhicule
	 * @throws PlaceOccupeeException
	 *             La place est déjà occupée
	 * @throws PlaceReserveeException
	 *             La place est réservée
	 */
	public void garerVehicule(Vehicule aGarer, Integer place)
			throws TypePlaceInvalideException, PlaceOccupeeException,
			PlaceReserveeException {
		try {
	...
	public static void main(String[] args) {
		...
		Vehicule v4 = new Voiture("g43ewvrsd", "marque", "modele",
				"John Michael");
		Vehicule v5 = new Voiture("FAf90ajsd", "marque", "modele",
				"John D'oeuf");
